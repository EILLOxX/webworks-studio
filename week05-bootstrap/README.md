...
[the nav bar feature, when on smaller screens you get the hamburger menu, it was faster to add it in which is very useful on smaller screens since the text would not naturally fit but the humburger menu fixes that issue.]
...
[A default i changed was the color theme, since it showed the company's colors better .]
...
[one thing i will not rebuild from scratch is the cards since bootstrap has it. it is the better choice because it saves precious work time and reduces the chance of having clutter]

## Live Site

[https://eilloxx.github.io/webworks-studio/week05-bootstrap]
